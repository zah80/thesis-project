...
router.post("/addImages", upload.fields([{ name: 'images', maxCount: 10 }]), authMiddleWare, laborerController.AddIamgesToLaborer);
...
router.get("/one/:id",  laborerController.getOneLaborerController);
