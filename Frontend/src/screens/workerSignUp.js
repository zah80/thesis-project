...
const WorkerSignUp = ({ navigation }) => {
  ...
  const fetchCountries = async () => {
    try {
      const response = await axios.get('http://192.168.100.31:3000/api/countries');
  ...
  const fetchCountryById = async (countryID) => {
    try {
      const response = await axios.get(`http://192.168.100.31:3000/api/countries/${countryID}`);
  ...
  const fetchJobs = async () => {
    try {
      const response = await axios.get('http://192.168.100.31:3000/api/jobs');
  ...
  const handleSignUp = async () => {
    try {
      ...
      const response = await axios.post('http://192.168.100.31:3000/api/laborers/create', {
        fullName,
        email,
        password,
        phone,
